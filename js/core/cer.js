...
export function normalizeForCer(s) {
...
/**
 * CER 계산.
 * @param {string} refText 참조(정답) 문장 — 원문 그대로 넣으면 내부에서 정규화
 * @param {string} hypText 인식 결과 문장
 * @returns {{distance:number, refLength:number, rate:number}|null} ref가 비면 null
 */
